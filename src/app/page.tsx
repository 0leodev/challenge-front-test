    ...
    <main className="p-4 sm:p-6 max-w-6xl mx-auto bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen">
      <div className="flex flex-col gap-0">
        <header className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-10">
          <h1 className="text-3xl font-bold">Challenge-Front</h1>
        ...
        {isConnected && !isWrongNetwork && (
          ...
          >
            <div className="bg-gradient-to-br rounded-2xl p-6 shadow-xl">
              <h2 className="text-2xl text-white mb-2">Net Worth</h2>
              <motion.p
                key={totalBalance}
        ...
        {!isConnected ? (
          <div className="flex items-center justify-center h-[50vh]">
            <div className="bg-gradient-to-br shadow-xl p-8 rounded-xl text-center">
              <p className="text-2xl font-bold mb-8">Please, connect your wallet</p>
              <ConnectButton.Custom>
                {({ openConnectModal }) => (
                  <button
                    onClick={openConnectModal}
          ...
          <>
            <div className="mb-8">
              <label htmlFor="targetAddress" className="block text-lg font-medium mb-2">
                Target Address:
              </label>
              <input
                id="targetAddress"
